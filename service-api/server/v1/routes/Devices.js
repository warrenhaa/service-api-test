...
import {
  ...
  getUserAnalytics,changeOwnerRules,getKibanaConnectionHistory,pincodeDetails,gatewaySettings
...
router.post('/change_owner', authVerification,restrictDemoAccount, verifyCompanyCode, verifyOccupant, getCompanyIdFromCode, changeOwnerRules(), validation, asyncErrorHandler(DevicesController.changeOwner));
