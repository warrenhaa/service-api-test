...
import {
  ...
  gatewayCameraList, gatewayCameraPlanLink, categoryAddRules, localCloudSyncupRules, getDeviceShadows,
  getUserAnalytics
...
router.post('/bulk', authVerification, verifyCompanyCode, verifyUserOrOccupant, getCompanyIdFromCode, createBulkDeviceRules(), DeviceValidation, asyncErrorHandler(DevicesController.createBulkDevices));
router.post('/', authVerification, verifyCompanyCode, verifyUserOrOccupant, getCompanyIdFromCode, createDeviceRules, validation, asyncErrorHandler(DevicesController.createDevice));
router.put('/bulk', authVerification, verifyCompanyCode, verifyUserOrOccupant, getCompanyIdFromCode, updateBulkDeviceRules(), DeviceValidation, asyncErrorHandler(DevicesController.updateBulkDevice));
router.delete('/gateway', authVerification, verifyCompanyCode, verifyUserOrOccupant, getCompanyIdFromCode, deleteGatewayRules(), validation, asyncErrorHandler(DevicesController.deleteGateway));
router.delete('/device', authVerification, verifyCompanyCode, verifyUserOrOccupant, getCompanyIdFromCode, deleteDeviceRules(), validation, asyncErrorHandler(DevicesController.deleteDevice));
