...
router.delete('/permissions/metadata/geofencing_disabled', authVerification, verifyCompanyCode, verifyOccupant, disableGeofencingRules(), validation, getCompanyIdFromCode, asyncErrorHandler(OccupantsPermissionsController.disableGeofencing));
