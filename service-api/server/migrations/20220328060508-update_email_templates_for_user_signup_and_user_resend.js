  ...
  up: async (queryInterface) => {
    ...
    INSERT INTO public.template_contents(
      ...
      VALUES ('403f456b-f509-42de-ad15-5b2b2867cd4e', 'InviteSent', 'en-US', '{
        "body": "<b> Welcome {{email}} </b> </br> </br> <p> {{inviter_email}} invited you to join {{company_name}}. Please click the button below to accept this invitation to register and access {{company_name}} portal </p> </br> </br> </mj-text> <mj-button font-size=\\"20px\\"  font-family=\\"Poppins\\" background-color=\\"#24a0ed\\" color=\\"white\\" padding-top=\\"200\\" inner-padding=\\"5px 10px\\" align=\\"center\\" font-weight:\\"normal\\" href=\\"{{button_link}}\\"> ACCEPT INVITATION </mj-button> <mj-text font-size=\\"18px\\" color=\\"{{textColor}}\\" font-family=\\"Poppins\\"> <p> Your invite expires on {{expires_at}} </p> If you have any questions or trouble, please contact  <a href=\\"{{contact_url}}\\">{{company_name}}</a> </br> </br> <p> Cheers, </p> </br> </br> The {{company_name}} Team <br/> <br/> </br>",
