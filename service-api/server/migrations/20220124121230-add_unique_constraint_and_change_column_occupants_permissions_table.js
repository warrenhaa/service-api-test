module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.addConstraint('occupants_permissions', ['gateway_id', 'sharer_occupant_id', 'receiver_occupant_id', 'company_id'],
      { type: 'unique', name: 'gateway_id_sharer_occupant_id_receiver_occupant_id_company_id_unique' });
  },
