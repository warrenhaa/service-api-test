module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`delete from activity_log_communication_configs where event_name ='camera_notification';
    ...
    delete from template_contents where key ='camera_notification';
...
VALUES ('bbf3aed6-1aa9-4b45-935c-bdef775b0b2e', 'MotionDetect', 'en',null,null, '{
    "body": "Camera motion detected for {{camera_name}} camera",
    "title": "Camera Alert"
