...
INSERT INTO public.template_contents(   
 ...
 VALUES ('329445e3-8330-42d5-86e7-d7b481618ff4', 'SignUp', 'no', '{
  "body": " <p> Takk for at du oppretter din profil. Vennligst bekreft din konto nå. Your confirmation code is <b>{{OTP}}</b>, it will be expired after 24 hours.</p> <p>Så snart din konto er bekreftet, vil vi veilede deg gjennom resten av oppsettprosessen.</p> <p>Velkommen til {{welcome_company}}!</p>",
  "banner": "Velkommen {{username}}!",
...
INSERT INTO public.template_contents(   
 ...
 VALUES ('3850fa80-34a5-4892-958d-8e0a18cb6efd', 'SignUp', 'pl', '{
  "body": "<p> Dziękujemy za utworzenie profilu. Potwierdź teraz swoje konto. Your confirmation code is <b>{{OTP}}</b>, it will be expired after 24 hours.</p> <p>Po potwierdzeniu konta, przeprowadzimy Cię przez pozostałą część procesu konfiguracji.</p> <p>Witamy w {{welcome_company}}!</p>",
...
INSERT INTO public.template_contents(   
 ...
 VALUES ('b61d80b2-3694-4973-b126-0e6830c87d13', 'SignUp', 'ru', '{
  "body": "<p>Спасибо, что создали аккаунт. Пожалуйста, подтвердите вашу учетную запись прямо сейчас. Your confirmation code is <b>{{OTP}}</b>, it will be expired after 24 hours.</p> <p>OКак только вы подтвердите вашу учетную запись, мы поможем вам выполнить настройку.</p> <p>Добро пожаловать в {{welcome_company}}!</p>",
...
INSERT INTO public.template_contents(   
 ...
 VALUES ('473bd6a3-033e-4722-8931-780ff5c95929', 'SignUp', 'sr', '{
  "body": "<p> Hvala što ste napravili svoji profil. Molim Vas potvrdite svoj nalog. Your confirmation code is <b>{{OTP}}</b>, it will be expired after 24 hours. </p> <p>Kada je Vaš nalog potvrđen, idemo kroz ostatak procesa registrovanja.</p> <p>Dobrodošli u {{welcome_company}}!</p>",
...
INSERT INTO public.template_contents(   
 ...
 VALUES ('8142dae6-83b9-4b27-a509-3a1beab3bd2f', 'SignUp', 'uk', '{
  "body": "<p> Спасибі, що створили акаунт. Будь ласка, підтвердіть ваш обліковий запис прямо зараз. Your confirmation code is <b>{{OTP}}</b>, it will be expired after 24 hours.</p> <p>Як тільки ви підтвердите свій обліковий запис, ми допоможемо вам налаштувати.</p> <p>Ласкаво просимо в {{welcome_company}}!</p>",
