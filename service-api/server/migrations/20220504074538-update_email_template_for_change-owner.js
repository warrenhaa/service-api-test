  ...
  up: async (queryInterface, Sequelize) => {
    ...
    INSERT INTO public.template_contents(
      ...
      VALUES ('8667aa3b-4d33-42ff-8357-76d9e5b265c3', 'OwnerUnregisteredGateway', 'en-US', '{
        ...
        "body": "You have unregistered the \\"{{gateway_name}}\\" ( {{gateway_code}} ). You no longer have access to the gateway and access shared with other users has also been revoked.<br/>In case you have not unregistered the gateway, then you can contact support team.",
    ...
    INSERT INTO public.template_contents(
      ...
      VALUES ('8677aa3b-4d33-42ff-8357-76d9e5b265c3', 'GatewayUnregistered', 'en-US', '{
        "banner": "Hi {{first_name}} {{last_name}}",   
        "body": "Owner unregistered the \\"{{gateway_name}}\\" ( {{gateway_code}} ). You no longer have access to the gateway.",
        "subject": "Gateway Unregistered"
       }', null, null, '2022-04-12 08:33:28.35+00', '2022-04-12 08:33:28.35+00', 'activity');
    `);
  },
